    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1><i class="fas fa-route"></i> Edit Rute</h1>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.rute.update', $data->id_rute) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="jarak" class="form-control" value="{{ old('jarak', $data->jarak) }}" min="0" step="0.1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Estimasi Durasi (menit)</label>
                                            <input type="number" name="estimasi_durasi" class="form-control" value="{{ old('estimasi_durasi', $data->estimasi_durasi) }}" min="1">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
