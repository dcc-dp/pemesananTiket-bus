                            ...
                            <form method="POST" action="{{ route('admin.operator.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_operator" class="form-control @error('kode_operator') is-invalid @enderror"
                                        value="{{ old('kode_operator') }}" required maxlength="30">
                                    @error('kode_operator')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_operator" class="form-control @error('nama_operator') is-invalid @enderror"
                                        value="{{ old('nama_operator') }}" required maxlength="150">
                                    @error('nama_operator')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Telepon</label>
                                            <input type="text" name="telepon" class="form-control" value="{{ old('telepon') }}" maxlength="30">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
